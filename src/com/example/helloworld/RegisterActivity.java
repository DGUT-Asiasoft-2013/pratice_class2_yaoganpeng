...
import com.example.helloworld.fragments.inputcells.PictureInputFragment;
...
public class RegisterActivity extends Activity {
	...
	PictureInputFragment fragInputAvatar;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragInputAvatar = (PictureInputFragment) getFragmentManager().findFragmentById(R.id.input_avatar);
...
//			.setIcon(android.R.drawable.ic_dialog_alert)
		...
		if (fragInputEmailAddress.getText().equals("")) {
			new AlertDialog.Builder(RegisterActivity.this)
			.setMessage("邮箱不能为空")
